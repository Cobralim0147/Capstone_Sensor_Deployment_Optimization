...
class OptimizationConfig:
    ...
    collection_a_star_resolution: float = 1 #checks the accuracy of the path
    collection_buffer_distance: float = 1
    collection_grid_resolution: float = 1.0
    collection_range_limit: float = 5.0
